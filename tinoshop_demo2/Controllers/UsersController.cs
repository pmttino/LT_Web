...
namespace tinoshop_demo2.Controllers
{
    ...
    public class UsersController : Controller
    {
        ...
        public UsersController(tinoshop_demo2Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.User != null ? 
                          ...
                          Problem("Entity set 'tinoshop_demo2Context.User'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'tinoshop_demo2Context.User'  is null.");
            }
            var user = await _context.User.FindAsync(id);
            if (user != null)
            {
